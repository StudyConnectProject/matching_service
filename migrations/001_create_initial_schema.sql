...
CREATE INDEX idx_match_requests_subject ON match_requests(subject);
...
CREATE INDEX idx_match_results_tutor_id ON match_results(tutor_id);
...
CREATE INDEX idx_match_history_request_id ON match_history(request_id);
CREATE INDEX idx_match_history_tutor_id ON match_history(tutor_id);
CREATE INDEX idx_match_history_action ON match_history(action);
